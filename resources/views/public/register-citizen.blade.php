...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Collga | Citizen Registration</title>
                    ...
                    <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="{{asset('assets/public/asset/img/landing/login-citizen-1.jpg')}}" class="bg" alt="First slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="{{asset('assets/public/asset/img/landing/login-citizen-2.jpg')}}" class="bg" alt="Second slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="{{asset('assets/public/asset/img/landing/login-citizen-3.jpg')}}" class="bg" alt="Third slide">
                            </div>
                        </div>
                    </div>
                </div>
                 ...
                 <br/><br/>
                    ...
                    <div class="citizen-login-logo justify-content-center">
                     ...
                     <div class="citizen-login-logo1">
                        <p class="">
                            <p class="text22"><b>Citizen Account</b></p>
                            <p class="text33 justify-content-center">For Odeda LGA citizen with LGA ID Number.</p>
                        </p>
                    </div>
                    <div class="optionlc"> 
                        <form>
                            <div class="form-group">
                                <input type="text" class="form-control11" id="formGroupExampleInput" placeholder="   LGA ID Number">
                            </div>
                           <div class="form-row">
                                <div class="col">
